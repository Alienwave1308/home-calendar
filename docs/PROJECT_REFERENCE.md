...
- Автоскидка “первого визита” отключена; вместо этого используются промокоды мастера.
- Промокод может давать либо процент скидки, либо зону эпиляции в подарок.
...
- `master_promo_codes` — промокоды мастера (процент или подарочная зона).
